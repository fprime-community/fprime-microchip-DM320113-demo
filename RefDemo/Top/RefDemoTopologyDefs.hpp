// ======================================================================
// \title  RefDemoTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef REFDEMO_REFDEMOTOPOLOGYDEFS_HPP
#define REFDEMO_REFDEMOTOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "RefDemo/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `RefDemo::TopologyState`. Only the type
