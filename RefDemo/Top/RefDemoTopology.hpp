// ======================================================================
// \title  RefDemoTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef REFDEMO_REFDEMOTOPOLOGY_HPP
#define REFDEMO_REFDEMOTOPOLOGY_HPP
// Included for access to RefDemo::TopologyState and RefDemo::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <RefDemo/Top/RefDemoTopologyDefs.hpp>

// Remove unnecessary RefDemo:: qualifications
 ...
 * RefDemo::TopologyState see: RefDemoTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type RefDemo::TopologyState see: RefDemoTopologyDefs.hpp.
 *
