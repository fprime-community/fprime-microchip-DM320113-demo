// ======================================================================
// \title  RefDemoTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <RefDemo/Top/RefDemoTopologyAc.hpp>
#include <RefDemo/Top/RefDemoPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(RefDemoPacketsPkts, RefDemoPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name RefDemo
namespace RefDemo {
